...
//		this._container.innerHTML =prefix+' : <span class="leaflet-draw-tooltip-subtext">' + subtext + '</span> <a href="#" class="close"><img src=\"/omsc/images/ic_tooltip_close.png\"/></a>' + '<br />' ;
		//2020 07 02 유승학 수정
		this._container.innerHTML =prefix+' : <span class="leaflet-draw-tooltip-subtext">' + subtext + '</span> <a href="#" class="close"><img src=\"img/ico_x.png\"/></a>' + '<br />' ;
		return this;
	},
});
